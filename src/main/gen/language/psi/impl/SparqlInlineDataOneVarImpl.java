...
public class SparqlInlineDataOneVarImpl extends ASTWrapperPsiElement implements SparqlInlineDataOneVar {

  public SparqlInlineDataOneVarImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SparqlVisitor visitor) {
    visitor.visitInlineDataOneVar(this);
  }
  ...
  public SparqlVar getVar() {
    return findNotNullChildByClass(SparqlVar.class);
  }
