...
public class SparqlIRIrefOrFunctionImpl extends ASTWrapperPsiElement implements SparqlIRIrefOrFunction {

  public SparqlIRIrefOrFunctionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SparqlVisitor visitor) {
    visitor.visitIRIrefOrFunction(this);
  }
