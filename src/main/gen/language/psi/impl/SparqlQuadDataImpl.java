...
public class SparqlQuadDataImpl extends ASTWrapperPsiElement implements SparqlQuadData {

  public SparqlQuadDataImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SparqlVisitor visitor) {
    visitor.visitQuadData(this);
  }
