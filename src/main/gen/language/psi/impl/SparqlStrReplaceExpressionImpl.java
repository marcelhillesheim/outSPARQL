...
public class SparqlStrReplaceExpressionImpl extends ASTWrapperPsiElement implements SparqlStrReplaceExpression {

  public SparqlStrReplaceExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SparqlVisitor visitor) {
    visitor.visitStrReplaceExpression(this);
  }
