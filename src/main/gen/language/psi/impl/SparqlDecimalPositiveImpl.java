...
public class SparqlDecimalPositiveImpl extends ASTWrapperPsiElement implements SparqlDecimalPositive {

  public SparqlDecimalPositiveImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SparqlVisitor visitor) {
    visitor.visitDecimalPositive(this);
  }
