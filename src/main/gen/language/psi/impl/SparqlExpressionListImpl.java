...
public class SparqlExpressionListImpl extends ASTWrapperPsiElement implements SparqlExpressionList {

  public SparqlExpressionListImpl(@NotNull ASTNode node) {
    super(node);
  }
