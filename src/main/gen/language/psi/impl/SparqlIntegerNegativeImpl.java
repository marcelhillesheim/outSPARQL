...
public class SparqlIntegerNegativeImpl extends ASTWrapperPsiElement implements SparqlIntegerNegative {

  public SparqlIntegerNegativeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SparqlVisitor visitor) {
    visitor.visitIntegerNegative(this);
  }
