...
public class SparqlQuadPatternImpl extends ASTWrapperPsiElement implements SparqlQuadPattern {

  public SparqlQuadPatternImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SparqlVisitor visitor) {
    visitor.visitQuadPattern(this);
  }
