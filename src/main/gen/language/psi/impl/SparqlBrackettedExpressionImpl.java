...
public class SparqlBrackettedExpressionImpl extends ASTWrapperPsiElement implements SparqlBrackettedExpression {

  public SparqlBrackettedExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public SparqlExpression getExpression() {
    return findNotNullChildByClass(SparqlExpression.class);
  }
