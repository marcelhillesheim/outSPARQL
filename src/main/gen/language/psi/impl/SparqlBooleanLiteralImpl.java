...
public class SparqlBooleanLiteralImpl extends ASTWrapperPsiElement implements SparqlBooleanLiteral {

  public SparqlBooleanLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }
