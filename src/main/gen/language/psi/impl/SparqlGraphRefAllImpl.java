...
public class SparqlGraphRefAllImpl extends ASTWrapperPsiElement implements SparqlGraphRefAll {

  public SparqlGraphRefAllImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SparqlVisitor visitor) {
    visitor.visitGraphRefAll(this);
  }
