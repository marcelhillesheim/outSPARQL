...
public class SparqlMultiplicativeExpressionImpl extends ASTWrapperPsiElement implements SparqlMultiplicativeExpression {

  public SparqlMultiplicativeExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
