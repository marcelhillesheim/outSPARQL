...
public class SparqlExistsFuncImpl extends ASTWrapperPsiElement implements SparqlExistsFunc {

  public SparqlExistsFuncImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SparqlVisitor visitor) {
    visitor.visitExistsFunc(this);
  }
