...
public class SparqlAggregateImpl extends ASTWrapperPsiElement implements SparqlAggregate {

  public SparqlAggregateImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public SparqlString getString() {
    return findChildByClass(SparqlString.class);
  }
