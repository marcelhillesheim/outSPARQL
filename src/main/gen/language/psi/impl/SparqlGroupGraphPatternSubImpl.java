...
public class SparqlGroupGraphPatternSubImpl extends ASTWrapperPsiElement implements SparqlGroupGraphPatternSub {

  public SparqlGroupGraphPatternSubImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SparqlVisitor visitor) {
    visitor.visitGroupGraphPatternSub(this);
  }
