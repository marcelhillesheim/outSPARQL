...
public class SparqlIntegerPositiveImpl extends ASTWrapperPsiElement implements SparqlIntegerPositive {

  public SparqlIntegerPositiveImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SparqlVisitor visitor) {
    visitor.visitIntegerPositive(this);
  }
