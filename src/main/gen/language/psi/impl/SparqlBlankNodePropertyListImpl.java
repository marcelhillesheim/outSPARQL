...
public class SparqlBlankNodePropertyListImpl extends ASTWrapperPsiElement implements SparqlBlankNodePropertyList {

  public SparqlBlankNodePropertyListImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public SparqlPropertyListNotEmpty getPropertyListNotEmpty() {
    return findNotNullChildByClass(SparqlPropertyListNotEmpty.class);
  }
