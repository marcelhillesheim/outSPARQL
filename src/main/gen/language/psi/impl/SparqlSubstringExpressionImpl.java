...
public class SparqlSubstringExpressionImpl extends ASTWrapperPsiElement implements SparqlSubstringExpression {

  public SparqlSubstringExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SparqlVisitor visitor) {
    visitor.visitSubstringExpression(this);
  }
