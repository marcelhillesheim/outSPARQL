...
public class SparqlDataBlockValueImpl extends ASTWrapperPsiElement implements SparqlDataBlockValue {

  public SparqlDataBlockValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SparqlVisitor visitor) {
    visitor.visitDataBlockValue(this);
  }
