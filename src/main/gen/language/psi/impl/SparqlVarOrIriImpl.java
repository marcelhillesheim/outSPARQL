...
public class SparqlVarOrIriImpl extends ASTWrapperPsiElement implements SparqlVarOrIri {

  public SparqlVarOrIriImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SparqlVisitor visitor) {
    visitor.visitVarOrIri(this);
  }
