...
public class SparqlUsingClauseImpl extends ASTWrapperPsiElement implements SparqlUsingClause {

  public SparqlUsingClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SparqlVisitor visitor) {
    visitor.visitUsingClause(this);
  }
