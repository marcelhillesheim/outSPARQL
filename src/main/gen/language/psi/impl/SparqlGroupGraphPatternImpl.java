...
public class SparqlGroupGraphPatternImpl extends ASTWrapperPsiElement implements SparqlGroupGraphPattern {
  ...
  @Override
  @Nullable
  public SparqlGroupGraphPatternSub getGroupGraphPatternSub() {
    return findChildByClass(SparqlGroupGraphPatternSub.class);
  }

  @Override
  @Nullable
  public SparqlSubSelect getSubSelect() {
    return findChildByClass(SparqlSubSelect.class);
  }
