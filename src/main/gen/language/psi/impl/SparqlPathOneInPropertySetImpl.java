...
public class SparqlPathOneInPropertySetImpl extends ASTWrapperPsiElement implements SparqlPathOneInPropertySet {

  public SparqlPathOneInPropertySetImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SparqlVisitor visitor) {
    visitor.visitPathOneInPropertySet(this);
  }
