...
public class SparqlRegexExpressionImpl extends ASTWrapperPsiElement implements SparqlRegexExpression {

  public SparqlRegexExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
