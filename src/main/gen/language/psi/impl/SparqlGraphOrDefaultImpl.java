...
public class SparqlGraphOrDefaultImpl extends ASTWrapperPsiElement implements SparqlGraphOrDefault {

  public SparqlGraphOrDefaultImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SparqlVisitor visitor) {
    visitor.visitGraphOrDefault(this);
  }
