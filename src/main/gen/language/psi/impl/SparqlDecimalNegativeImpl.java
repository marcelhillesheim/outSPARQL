...
public class SparqlDecimalNegativeImpl extends ASTWrapperPsiElement implements SparqlDecimalNegative {

  public SparqlDecimalNegativeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SparqlVisitor visitor) {
    visitor.visitDecimalNegative(this);
  }
