...
public class SparqlNotExistsFuncImpl extends ASTWrapperPsiElement implements SparqlNotExistsFunc {

  public SparqlNotExistsFuncImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SparqlVisitor visitor) {
    visitor.visitNotExistsFunc(this);
  }
